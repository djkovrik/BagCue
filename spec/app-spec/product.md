...
Revision `2026-09-10-qg008-production-ready` incorporates the owner's confirmation that all legal reviews are complete, the privacy policy is stable at `https://sedsoftware.com/apps/bagcue/policy.html`, and the shared privacy-region endpoint is final, stable, operationally complete, and production-ready, while retaining the previously confirmed CI/release setup. Product scope, AC-001 through AC-051, QG-001 through QG-012, SCREEN-001 through SCREEN-011, and ASSET-001 through ASSET-017 remain required as declared. Legal approval, initial external setup, and QG-008 endpoint readiness are no longer unperformed prerequisites; the remaining candidate-specific build, publication, store-parity, device, and receipt evidence remains mandatory under its respective gates.
